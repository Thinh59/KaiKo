...
// ===== TC_UC08_02 – Xem bảng xếp hạng (Leaderboard) =====
...
// Mở tab BXH
WebUI.click(xp(DOCK_BXH))

// Kỳ vọng: tiêu đề "Bảng xếp hạng ELO" hiển thị
WebUI.waitForElementVisible(xp("//h2[contains(.,'Bảng xếp hạng ELO')]"), 15)
WebUI.verifyElementVisible(xp("//h2[contains(.,'Bảng xếp hạng ELO')]"))
